...
const Section_2 = () => {
    ...
    return (
        <Container id='s2' className='mt-5 mb-5'>
            ...
            <p className='text-center cs-c cs-fw mb-5 w-50 mx-auto'>Our aim is to make it quick and easy for you to access your favourite websites. 
            Your bookmarks sync between your devices so you can access them on the go.</p>
            <Container ref={parentRef}>
                <Nav variant="tabs" defaultActiveKey="link-1" className='flex-lg-row flex-column align-items-center w-50 mx-auto justify-content-around mb-5 cs-b'>
                    <Nav.Item >
                        <Nav.Link eventKey='link-1' className='cs-navlink-2 pb-4' onClick={() => setActiveLink('Bookmark')}>Simple Bookmarking</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                        <Nav.Link eventKey='link-2' className='cs-navlink-2 pb-4' onClick={() => setActiveLink('Search')}>Speedy Searching</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                        <Nav.Link eventKey='link-3' className='cs-navlink-2 pb-4' onClick={() => setActiveLink('Sharing')}>Easy Sharing</Nav.Link>
                    </Nav.Item>
                </Nav>
...
const Bookmark = () => {
    return (
        <Row>
            ...
            <Col xs={12}
                 lg={6} className='d-flex flex-column justify-content-center mb-5 mt-5'>
                <h3 className='h2 mb-3'>Bookmark in one click</h3>
                ...
                <Button variant='custom' className='cs-btn-ch w-25 shadow'>More Info</Button>
            </Col>
        </Row>
    );
};
...
const Search = () => {
    return (
        <Row>
            <Col xs={12}
                 lg={6} className='cs-b-2'>
                <Image fluid src={ImgIll_2} alt='IllTab' className='d-block mx-auto' />
            </Col>
            <Col xs={12}
                 lg={6} className='d-flex flex-column justify-content-center mb-5'>
                <h3 className='h2 mb-3'>Intelligent search</h3>
...
const Sharing = () => {
    return (
        <Row>
            ...
            <Col xs={12}
                 lg={6} className='d-flex flex-column justify-content-center mb-5'>
                <h3 className='h2 mb-3'>Share your bookmarks</h3>
